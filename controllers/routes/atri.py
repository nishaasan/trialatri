...
class Atri:
	def __init__(self, state: Any):
		...
		self.that_delight_and_inspire_people = state["that_delight_and_inspire_people"]
	...
	@property
	def that_delight_and_inspire_people(self):
		self._getter_access_tracker["that_delight_and_inspire_people"] = {}
		return self._that_delight_and_inspire_people
	@that_delight_and_inspire_people.setter
	def that_delight_and_inspire_people(self, new_state):
		self._setter_access_tracker["that_delight_and_inspire_people"] = {}
		global default_state
		self._that_delight_and_inspire_people = TextBox(new_state, default_state["that_delight_and_inspire_people"])
	...
	def _to_json_fields(self):
		return {
			...
			"that_delight_and_inspire_people": self._that_delight_and_inspire_people,
			"Image4": self._Image4,
			"Image3": self._Image3,
